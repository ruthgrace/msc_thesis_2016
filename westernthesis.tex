...
\newcommand{\examth}{Dr. Jeremy Burton/Gregory Thorn}
\newcommand{\examf}{}
...
With the advent of next generation sequencing, scientists can obtain a more comprehensive snapshot of the bacterial composition of the microbiome, what genes they have, and what proteins they produce. We are in a phase of developing the experiments and accompanying statistical techniques to investigate the exact mechanisms by which the human microbiome affects health and disease. In this thesis we explore alternatives to the standard weighted and unweighted UniFrac metric for measuring the difference between microbiome samples, to extract different trends and outliers. We also apply next generation sequencing and computational analysis techniques to gut microbiome data to examine the relationship of the microbiota to non alcoholic fatty liver disease.

\vfill
\textbf{Keywords:} Human microbiome, next generation sequencing, bioinformatics, non-alcoholic fatty liver disease
\newpage
\tableofcontents\newpage
\newpage
