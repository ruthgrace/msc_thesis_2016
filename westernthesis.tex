...
\newcommand{\titl}{Microbiome analysis: methods and applications}
\newcommand{\spinetitle}{Microbiome analysis: methods and applications}%only if the above is more than 60 characters
