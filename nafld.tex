...
\section{Methods}
In total, 92 samples were collected: 41 from patients with non-alcoholic steatohepatitis (NASH), 18 from patients with simple steatosis (SS), and 33 from healthy controls. The median BMIs were 26.70, 27.34, and 32.06, and the median ages were 36, 49, and 46.5 for healthy, SS, and NASH respectively.
