...
\section{Methods}
In total, 92 samples were collected: 41 from patients with non-alcoholic steatohepatitis (NASH), 18 from patients with simple steatosis (SS), and 33 from healthy controls.

[TO DO: include information about sample collection and exclusion criteria + BMI of healthy controls]
...
\caption{ \textbf{List of inclusion and exclusion criteria.} The first table has the inclusion and exclusion criteria for the 16S rRNA gene tag experiment, and the second table has the exclusion critiera for the patients selected for the metagenomic study.}
