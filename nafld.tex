...
\hline
\bf{OTU name} & \bf{Healthy Vs. NASH} & \bf{Healthy Vs. SS} & \bf{Healthy vs. NASH} & \bf{16S genus} & \bf{MetaPhlAn}\\
& \bf{metagenomic study} & \bf{effect sizes} & \bf{effect sizes} & \bf{effect sizes} & \bf{effect sizes}\\
& \bf{effect sizes} & & & & \\ \hline
\end{tabular}
